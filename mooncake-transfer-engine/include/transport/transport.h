...
class Transport {
   ...
   public:
    ...
    struct Slice {
        ...
        // Non-owning pointer into TransferMetadata::SegmentDesc interned nic
        // paths. When set, peerNicPath() returns *interned_peer_nic_path so
        // the mapping path does not allocate a per-slice std::string.
