...
TEST(BufferRangeIndex, LastHitReusesHintDevice) {
    ...
    ASSERT_EQ(RdmaTransport::selectDevice(&desc, 0x1100, 32, hinted_buffer,
                                          hinted_device, 0, buffer_id,
                                          first_device),
              0);
...
TEST(BufferRangeIndex, DeviceHintDoesNotFollowBufferJump) {
    ...
    ASSERT_EQ(RdmaTransport::selectDevice(&desc, 0x2080, 16, jumped_buffer,
                                          jumped_device, 0, buffer_id,
                                          device_id),
              0);
